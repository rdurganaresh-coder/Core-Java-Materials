...
# 234.Do IdentityHashMap thread-safe?  
...
in Java 8?  
# 394.It is possible to have default method definition in an interface without marking it with default keyword?  
...
# 405.It is possible to define a static method in an Interface?  
...
# 34.Can you cast an int variable into a byte variable? What happens if the value of int is larger than byte?  
...
# 460.What is the difference between the expressions 
```java
String s = "Temporary" 
